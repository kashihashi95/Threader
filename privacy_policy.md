...
- **No Remote AI Transmission:** Thread content, discussions, voice configurations, speech tokens, and generated audio streams are **never** transmitted to remote third-party AI or cloud speech providers (such as OpenAI, ElevenLabs, Google Cloud Text-to-Speech, or Microsoft Azure).
